...
# openshift.io/ttlcontroller-bundle:$VERSION and openshift.io/ttlcontroller-catalog:$VERSION.
IMAGE_TAG_BASE ?= openshift.io/ttlcontroller
...
.PHONY: test-e2e  # Run e2e tests against envtest (local API server + etcd).
test-e2e: envtest
